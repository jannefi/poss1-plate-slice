...
"""Candidate-selection filters of Solano et al. (2022), Section 2.
    ...
    doi:10.1093/mnras/stac1552

Referred to throughout this repository as "the MNRAS filters". Thresholds are
taken from that section and are not free parameters -- changing one is a
deviation from the published method and should be recorded as such, not tuned.
"""
